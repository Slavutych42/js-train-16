...
function filterStudentsByGrade(students, grade) {
  ...
  const filtStud = students.filter((student) => 
    student.grade === grade
  )

  filtStud.forEach((student) => {
    console.log(`Ім'я студента: ${student.name}, Оцінка: ${student.grade}`);
  })
} 
...
function compareArrays(arr1, arr2) {
  ...
  const jsonArr1 = JSON.stringify(sortArr1);
...
function countVowelsAndConsonants(word) {
  ...
  console.log(`Кількість голосних: ${aCount}`);
  console.log(`Кількість приголосних: ${bCount}`);
}
